...
#app-sidebar-brand::before {
  /* Owl mark — inline SVG from @codigosinsiesta/theme brand assets
     ...
     Drawn at viewBox 25940 20865 18235 13449 with three layered groups:
       - body silhouette (fill currentColor)
       - eye outlines + beak diamond (stroke currentColor, w=470)
       - pupils (fill currentColor)
     Injected as background-image so currentColor inherits the parent's
     color, enabling filter: drop-shadow() for the glow effect. */
  content: '' !important;
